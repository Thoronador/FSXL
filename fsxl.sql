...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 29. Jun 2014 um 18:59
...
-- Datenbank: `fsxl`
--
CREATE DATABASE IF NOT EXISTS `fsxl` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `fsxl`;
...
('news_perpage', '10'),
('kontaktmail', 'example@example.com'),
('news_spamtime', '60'),
('news_spamfilter', ''),
('news_commentsperpage', '0'),
('news_headlines', '4'),
...
('newssubmitmail', '1'),
('jobmail', '1'),
('systemmail', 'example@example.com'),
('ticker_lastupdate', '0'),
('link_headlines', '6'),
('fscodes', '6'),
('article_showall', '1'),
...
(1, 'admin', 'aeaca9dbb58470c98f03dbf5a3187f77', 'NIMFk-40XO');
...
(1, 'example@example.com', 1, 0, '', '', '0', 0, '0', 1, 0);
